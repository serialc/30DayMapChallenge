...
# Overall map
svg('../../day01/day16_redux.svg', width = 8, heigh=4)
par(mar=c(0,0,0,0), mfrow=c(1,3))

plot(lcdp$geometry, col='#c9baa6ff')
plot(blpts, add=TRUE, pch=19, cex=0.1)
plot(lcdp$geometry, col='#c9baa6ff')
plot(blpts_ballotnorm, add=TRUE, pch=19, cex=0.1)
plot(lcdp$geometry, col='#c9baa6ff')
plot(blpts_ballotnormgeo, add=TRUE, pch=19, cex=0.1)
dev.off()
